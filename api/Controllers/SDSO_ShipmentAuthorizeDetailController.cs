...
{
    public class SDSO_ShipmentAuthorizeDetailController : ApiController
    {
        [Route("asha/SDSO_ShipmentAuthorizeDetail/GetAll")]
        [HttpGet]
        ...
        [Route("asha/SDSO_ShipmentAuthorizeDetail/{id}")]
        [HttpGet]
        public object Get(string id)
        {
                                                         ...
                                                         ConnectionStrings["AshaERPEntities"].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT SDSO_ShipmentAuthorize.Code, SDSO_ShipmentAuthorize.Title, " +
                                                       ...
                                                       "INNER JOIN WMInv_Part ON SDSO_ShipmentAuthorize.Code = WMInv_Part.Code " +
        ...
        [Route("asha/SDSO_ShipmentAuthorizeDetail/{phlWMCode}")]
        [HttpPost]
        ...
        [Route("asha/SDSO_ShipmentAuthorizeDetail/{phlWMCode}/{sequence}")]
        [HttpPut]
