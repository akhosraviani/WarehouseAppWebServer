...
namespace api.Controllers
{
    ...
    {
        [Route("asha/InventoryPart/GetAll")]
        [HttpGet]
        ...
        [Route("asha/InventoryPart/GetAllOpen")]
        [HttpGet]
        ...
        public HttpResponseMessage Get(string id)
        {
            ...
            using (SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.
                                                         ConnectionStrings["AshaERPEntities"].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM WMInv_Part WHERE Code = '" + id + "'"
                                                        , con))
                {
                    con.Open();
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        [Route("asha/InventoryPart/GetPartLot/{PartCode}")]
        [HttpGet]
